...
Twenty was built to be developer-friendly, offering powerful APIs that adapt to your custom data model. We provide two API categories (Core and Metadata), each available in REST and GraphQL formats.
